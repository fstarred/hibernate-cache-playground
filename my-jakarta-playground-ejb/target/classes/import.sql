...
Insert into ARTICLE (NAME,TYPE,DESCRIPTION) values ('PEC-SILVER','EMAIL','PEC GOLD ELITE VERSION');
Insert into ARTICLE (NAME,TYPE,DESCRIPTION) values ('PEC-GOLD','EMAIL','PEC GOLD ELITE VERSION');
Insert into ARTICLE (NAME,TYPE,DESCRIPTION) values ('PEC-BRONZE-HUB','HUB','PEC HUB BRONZE VERSION');
Insert into ARTICLE (NAME,TYPE,DESCRIPTION) values ('PEC-GOLD-HUB','HUB','PEC HUB GOLD VERSION');
...
-- PAYMENT_METHOD
Insert into CUST_PAYMENT_METHOD (ID,CUST_ID,TYPE,NUMBER) values (1,1,'VISA','4716299347280476')
Insert into CUST_PAYMENT_METHOD (ID,CUST_ID,TYPE,NUMBER) values (2,1,'MASTERCARD','5185374953101842')
Insert into CUST_PAYMENT_METHOD (ID,CUST_ID,TYPE,NUMBER) values (3,2,'MASTERCARD','5367701116820456')
Insert into CUST_PAYMENT_METHOD (ID,CUST_ID,TYPE,NUMBER) values (4,3,'VISA','4716856202465839')
