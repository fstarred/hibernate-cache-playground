...
a persistence unit "my-jakarta-playgroundPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "my-jakarta-playground\pom.xml":
...
artifacts ("my-jakarta-playground-ejb.jar" and "my-jakarta-playground-web.war") are already built. You can build
